...
**_Software Requirements Specification for <Project> Page PAGE \\_ MERGEFORMAT 6\***
...
**Note :** All the users are expected to be Internet literate and be able to use a search engine. _XE "Reader"_
...
_<Itemize the detailed functional requirements associated with this feature. These are the software capabilities that must be present in order for the user to carry out the services provided by the feature, or to execute the use case. Include how the product should respond to_

` `_anticipated error conditions or invalid inputs. Requirements should be concise, complete, unambiguous, verifiable, and necessary. Use “TBD” as a placeholder to indicate when necessary information is not yet available.>_
