    ...
    return (
      <>
        ...
        <div className="privacy-container">
          ...
          <ul style={{ listStyleType: "disc" }} className="ml-4 pl-4">
            <li>
              <p>
            ...
            <li>
              <p>
                ...
                in this Agreement) refers to Crossify.
              </p>
            </li>
            <li>
              <p>
          ...
          <h3 className="text-xl mt-2">Usage Data</h3>
          ...
          <h3 className="text-xl mt-2">Tracking Technologies and Cookies</h3>
          <p>
          ...
          <h3 className="text-xl mt-2">Law enforcement</h3>
          <p>
          ...
          <h3 className="text-xl mt-2">Other legal requirements</h3>
          <p>
          ...
          <h1 className="text-3xl mt-4 font-semibold">Children's Privacy</h1>
          <p>
          ...
          <h1 className="text-3xl mt-4 font-semibold">Contact Us</h1>
          <p>
            If you have any questions about this Privacy Policy, You can contact
            us:
          </p>
          <ul style={{ listStyleType: "disc" }} className="ml-4 pl-4">
            <li>By email: crossify.vgec@gmail.com</li>
          </ul>
        </div>
        <Footer />
      </>
