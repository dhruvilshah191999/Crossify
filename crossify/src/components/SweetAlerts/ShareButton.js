...
export default class SweetAlertModal extends Component {
  ...
  render() {
    return (
      <>
        <motion.button
          className="text-beta bg-white shadow border border-solid  hover:bg-beta hover:text-white active:bg-blue-600 font-bold uppercase text-xs px-4 py-2 rounded-full outline-none focus:outline-none mr-1  ease-linear transition-all duration-150"
          type="button"
