...
//     <div x-data="{ dropdownOpen: true }" className="relative my-32">
//         <button @click="dropdownOpen = !dropdownOpen" className="relative z-10 block rounded-md bg-white p-2 focus:outline-none">
...
//         <div x-show="dropdownOpen" @click="dropdownOpen = false" className="fixed inset-0 h-full w-full z-10"></div>

//         <div x-show="dropdownOpen" className="absolute right-0 mt-2 bg-white rounded-md shadow-lg overflow-hidden z-20" style="width:20rem;">
//             <div className="py-2">
